...
cd jmakepp
./jmakepp_linux build 2.0.3  # On Linux
# or
jmakepp_windows.exe build 2.0.3  # On Windows
```
...
## 📌 Latest Changes (v2.0.3)

fixed a bug where the update command would not remove the old binary
